...
# Source dir
Dir <- "C:\\data\\PSC\\CTC\\2016\\Chinook Model Base Period\\Model Comparison Package\\7 Catch\\"

# Set the paths to the necessary input files and output path
paths = list(paste(Dir,"FishLUT.csv",sep=""),
             paste(Dir,"StkLUT.csv",sep=""),
             paste(Dir,"1702P_fish_AABM_CCC.csv",sep=""),
             paste(Dir,"1702P_fish_ISBM_CCC.csv",sep=""),
             paste(Dir,"clb1702obsCatch.csv",sep=""),
             paste(Dir,"CLB1702auxCatch.csv",sep=""),
             paste(Dir,"bpP22017P_fish_AABM_CCC.csv",sep=""),
             paste(Dir,"bpP22017P_fish_ISBM_CCC.csv",sep=""),
             paste(Dir,"bpP2obsCatch.csv",sep=""),
             paste(Dir,"bpP2auxCatch.csv",sep=""),
             paste(Dir,"Figs\\",sep=""))
